<template>
  <header class="bg-white h-14 shadow justify-between p-4 items-center flex">
    <button
      @click="emit('toggle-sidebar')"
      class="flex items-center justify-center rounded transition-colors w-8 h-8 hover:bg-black/10 text-gray-700"
    >
      <Bars3Icon class="w-6" />
    </button>
