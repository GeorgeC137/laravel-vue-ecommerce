            ...
            <div class="bg-white rounded-lg shadow p-3 md:col-span-2">
                <form x-data="{
                    ...
                    <div class="grid grid-cols-2 mb-3 gap-3">
                        <x-text-input type="text" name="first_name" value="{{ old('first_name', $customer->first_name) }}" placeholder="First Name" class="rounded w-full focus:border-purple-600 border-gray-300 focus:ring-purple-600" />
                        <x-text-input type="text" name="last_name" value="{{ old('last_name', $customer->last_name) }}" placeholder="Last Name" class="rounded w-full focus:border-purple-600 border-gray-300 focus:ring-purple-600" />
                    </div>

                    <div class="mb-3">
                        <x-text-input class="rounded w-full focus:ring-purple-600 focus:border-purple-600 border-gray-300" type="text" name="email" placeholder="Your Email" value="{{ old('email', $user->email) }}" />
                    </div>

                    <div class="mb-3">
                        <x-text-input class="rounded w-full focus:ring-purple-600 focus:border-purple-600 border-gray-300" type="text" name="phone" placeholder="Your Phone Number" value="{{ old('phone', $customer->phone) }}" />
                    </div>

                    <h2 class="text-xl mt-6 mb-2 font-semibold">Billing Address</h2>
                    <div class="grid grid-cols-2 mb-3 gap-3">
                        <div>
                            <x-text-input class="rounded w-full focus:border-purple-600 focus:ring-purple-600 border-gray-300" name="billing[address1]" placeholder="Address 1" type="text" x-model="billingAddress.address1" />
                        </div>
                        <div>
                            <x-text-input class="rounded w-full focus:border-purple-600 focus:ring-purple-600 border-gray-300" name="billing[address2]" placeholder="Address 2" type="text" x-model="billingAddress.address2" />
                        </div>
                    </div>

                    <div class="grid grid-cols-2 mb-3 gap-3">
                        <div>
                            <x-text-input type="text" placeholder="City" name="billing[city]" class="w-full rounded focus:border-purple-600 focus:ring-purple-600 border-gray-300" x-model="billingAddress.city" />
                        </div>
                        <div>
                            <x-text-input type="text" placeholder="Zip Code" name="billing[zip_code]" class="w-full rounded focus:border-purple-600 focus:ring-purple-600 border-gray-300" x-model="billingAddress.zip_code" />
                        </div>
                    </div>

                    <div class="grid grid-cols-2 mb-3 gap-3">
                        <div>
                            <x-text-input type="select" name="billing[country_code]" x-model="billingAddress.country_code" class="w-full rounded focus:border-purple-600 focus:ring-purple-600 border-gray-300">
                        ...
                        <div>
                            <template x-if="billingCountryStates">
                                <x-text-input type="select" x-model="billingAddress.state" name="billing[state]" class="w-full rounded focus:border-purple-600 focus:ring-purple-600 border-gray-300">
                            ...
                            <template x-if="!billingCountryStates">
                                <x-text-input type="text" name="billing[state]" x-model="billingAddress.state" placeholder="State" class="w-full rounded focus:border-purple-600 focus:ring-purple-600 border-gray-300" />
                            </template>
                        </div>
                    </div>
                    ...
                    <div class="flex mt-6 mb-2 justify-between">
                        ...
                        <label for="sameAsBillingAddress" class="text-gray-700">
                            <input type="checkbox" @change="$event.target.checked ? shippingAddress = { ...billingAddress } : ''" class="text-prple-600 mr-2 focus:border-purple-600" id="sameAsBillingAddress"> Same as Billing
                        </label>
                    </div>

                    <div class="grid grid-cols-2 mb-3 gap-3">
                        <div>
                            <x-text-input class="w-full rounded border-gray-300 focus:border-purple-600 focus:ring-purple-600" placeholder="Address 1" name="shipping[address1]" x-model="shippingAddress.address1" type="text" />
                        </div>
                        <div>
                            <x-text-input class="w-full rounded border-gray-300 focus:border-purple-600 focus:ring-purple-600" placeholder="Address 2" name="shipping[address2]" x-model="shippingAddress.address2" type="text" />
                        </div>
                    </div>

                    <div class="grid grid-cols-2 mb-3 gap-3">
                        <div>
                            <x-text-input class="w-full rounded border-gray-300 focus:ring-purple-600 focus:border-purple-600" type="text" name="shipping[city]" x-model="shippingAddress.city" placeholder="City"  />
                        </div>
                        <div>
                            <x-text-input class="w-full rounded border-gray-300 focus:ring-purple-600 focus:border-purple-600" type="text" name="shipping[zip_code]" x-model="shippingAddress.zip_code" placeholder="Zip Code"  />
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 mb-3 gap-3">
                        ...
                        <div>
                            ...
                            <template x-if="!shippingCountryStates">
                                <x-text-input class="w-full border-gray-300 focus:ring-purple-600 focus:border-purple-600 rounded" type="text" name="shipping[state]" x-model="shippingAddress.state" Placeholder="State" />
                            </template>
                        </div>
                    </div>
